    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppFiles", x => x.Cid);
                    table.ForeignKey(
                        name: "FK_AppFiles_Apps_AppId",
                        column: x => x.AppId,
                        principalTable: "Apps",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IpfsUri = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Libraries", x => new { x.UserId, x.AppId, x.PaymentId });
                    table.ForeignKey(
                        name: "FK_Libraries_Apps_AppId",
                        column: x => x.AppId,
                        principalTable: "Apps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Libraries_PaymentRecords_PaymentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Libraries_AppId",
                table: "Libraries",
                column: "AppId");

            migrationBuilder.CreateIndex(
                name: "IX_Libraries_PaymentId",
                table: "Libraries",
                column: "PaymentId",
                unique: true);
